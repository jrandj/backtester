...
class Backtester:
    ...
    def run_benchmark(self):
        ...
        self.cerebro_benchmark.addstrategy(Benchmark, verbose=True)
...
def main():
    ...
    print(f'Final Portfolio Value: {backtester.ending_value:,.2f}')
    print(f'Duration: {backtester.format_time(duration)}')
